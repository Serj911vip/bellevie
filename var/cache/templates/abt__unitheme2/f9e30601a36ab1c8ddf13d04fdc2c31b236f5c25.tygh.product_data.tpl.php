<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 17:53:12
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\common\product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14103268835e4bfa58e2e487-11802488%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9e30601a36ab1c8ddf13d04fdc2c31b236f5c25' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\common\\product_data.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14103268835e4bfa58e2e487-11802488',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfa592f5c12_59614728',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfa592f5c12_59614728')) {function content_5e4bfa592f5c12_59614728($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\modifier.enum.php';
...
" <?php echo smarty_function_live_edit(array('name'=>"product:product:".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'phrase'=>$_smarty_tpl->tpl_vars['product']->value['product']),$_smarty_tpl);?>
><?php }
echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['product'],88,"...",true);
if ($_smarty_tpl->tpl_vars['hide_links']->value) {?></strong><?php } else { ?></a><?php }?>
    <?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><i class="ut2-icon-highlight_off"></i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['out_of_stock_text']->value, ENT_QUOTES, 'UTF-8');?>
</span><?php }
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_features")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_features"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['show_features']->value&&$_smarty_tpl->tpl_vars['product']->value['abt__ut2_features']) {?>
        <?php $_smarty_tpl->tpl_vars['max_features'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['settings']->value['abt__ut2']['product_list']['max_features'])===null||$tmp==='' ? 5 : $tmp), null, 0);?>
        <div class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
" />
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/product_features_short_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('features'=>array_slice($_smarty_tpl->tpl_vars['product']->value['abt__ut2_features'],0,$_smarty_tpl->tpl_vars['max_features']->value),'no_container'=>true), 0);?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['product']->value['list_discount']||$_smarty_tpl->tpl_vars['product']->value['discount']) {?>ty-list-price<?php }?> ty-nowrap" id="old_price_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                <span id="line_old_price_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><span class="ty-strike"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>(($tmp = @$_smarty_tpl->tpl_vars['product']->value['original_price'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['product']->value['base_price'] : $tmp),'span_id'=>"old_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value)), 0);?>
</span></span>
            <?php } elseif ($_smarty_tpl->tpl_vars['product']->value['list_discount']) {?>
                <span id="line_list_price_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><span class="ty-strike"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['list_price'],'span_id'=>"list_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value)), 0);?>
</span></span>
            <?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("list_discount_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['show_price_values']->value&&$_smarty_tpl->tpl_vars['show_list_discount']->value) {?>
        <?php $_smarty_tpl->tpl_vars["prc"] = new Smarty_variable("discount_prc", null, 0);?>
        <?php if ($_smarty_tpl->tpl_vars['product']->value['list_discount_prc']>0) {?>
            <?php $_smarty_tpl->tpl_vars["prc"] = new Smarty_variable("list_discount_prc", null, 0);?>
        <?php }?>
        <span class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
$_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp2." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%</em>", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp3." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%</em>", null, 0);?>
                <?php }?>
...
:</label>
                                <?php }?>
                                <span class="ty-qty-out-of-stock ty-control-group__item"><i class="ut2-icon-highlight_off"></i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['out_of_stock_text']->value, ENT_QUOTES, 'UTF-8');?>
</span>
                            </div>
                        <?php }?>
                    <?php }?>
...
">
                            <?php if ($_smarty_tpl->tpl_vars['product_amount']->value>0) {?>
                                <i class="ty-icon-ok"></i><?php echo $_smarty_tpl->__("in_stock");?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("capture_product_labels_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_discount_label']->value&&($_smarty_tpl->tpl_vars['product']->value['discount_prc']||$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])&&$_smarty_tpl->tpl_vars['show_price_values']->value) {?>
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp4." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%</em>", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp5." <em>".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%</em>", null, 0);?>
                <?php }?>

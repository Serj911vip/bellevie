<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 17:53:23
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\blocks\my_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15324890965e4bfa6384e677-52693114%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73e69eef8d617331fbfba34b84ecb42815c75b4e' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\blocks\\my_account.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15324890965e4bfa6384e677-52693114',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfa638e2297_02242066',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfa638e2297_02242066')) {function content_5e4bfa638e2297_02242066($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\block.hook.php';
...
<div class="ty-dropdown-box" id="account_info_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['snapping_id'], ENT_QUOTES, 'UTF-8');?>
">
    <div id="sw_dropdown_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'UTF-8');?>
" class="ty-dropdown-box__title cm-combination">
        <div>
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"my_account:dropdown_title")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"my_account:dropdown_title"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<i class="ut2-icon-outline-expand_more"></i></span>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"my_account:dropdown_title"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

        </div>
    </div>

    <div id="dropdown_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'UTF-8');?>
...
" rel="nofollow"><?php echo $_smarty_tpl->__("downloads");?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php }?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"ab__so_seohide:my_account_menu")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"ab__so_seohide:my_account_menu"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
if ($_smarty_tpl->tpl_vars['compared_products']->value) {?> (<?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['compared_products']->value), ENT_QUOTES, 'UTF-8');?>
                ...
                <?php }?>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"ab__so_seohide:my_account_menu"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" rel="nofollow" class="ty-btn <?php if ($_smarty_tpl->tpl_vars['is_vendor_with_active_company']->value) {?>ty-btn__tertiary<?php } else { ?>ty-btn__primary<?php }?>"><?php echo $_smarty_tpl->__("sign_out");?>
            ...
            <?php } else { ?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"ab__so_seohide:my_account_buttons")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"ab__so_seohide:my_account_buttons"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" rel="nofollow" class="ty-btn ty-btn__primary"><?php echo $_smarty_tpl->__("register");?>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"ab__so_seohide:my_account_buttons"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

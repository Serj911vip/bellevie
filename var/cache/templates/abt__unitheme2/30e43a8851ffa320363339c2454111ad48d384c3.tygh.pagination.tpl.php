<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 18:10:47
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\common\pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10429077585e4bfe77482f65-88628940%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30e43a8851ffa320363339c2454111ad48d384c3' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\common\\pagination.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10429077585e4bfe77482f65-88628940',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfe774cf361_39318935',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfe774cf361_39318935')) {function content_5e4bfe774cf361_39318935($_smarty_tpl) {?><?php
...
<?php if ($_smarty_tpl->tpl_vars['pagination']->value['total_pages']>1) {?>
    ...
    <?php }?>
    <div class="ty-pagination" id="pagination_block<?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>_bottom<?php }?>">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['next_range_from'], ENT_QUOTES, 'UTF-8');?>
 - <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['next_range_to'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php }?>
    <!--pagination_block<?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>_bottom<?php }?>--></div>
    <?php if (Smarty::$_smarty_vars['capture']['pagination_open']=="Y") {?>
        </div>
    <?php }?>
    <?php } else { ?>

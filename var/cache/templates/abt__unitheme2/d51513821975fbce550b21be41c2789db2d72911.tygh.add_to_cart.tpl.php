<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 18:11:37
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\buttons\add_to_cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:674488805e4bfea94468c1-40455481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd51513821975fbce550b21be41c2789db2d72911' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\buttons\\add_to_cart.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '674488805e4bfea94468c1-40455481',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfea9487d99_98235809',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfea9487d99_98235809')) {function content_5e4bfea9487d99_98235809($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('abt__ut2.add_to_cart','sign_in_to_buy','text_login_to_add_to_cart','abt__ut2.add_to_cart','sign_in_to_buy','text_login_to_add_to_cart'));
?>
...
$_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"buttons:add_to_cart")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"buttons:add_to_cart"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['allow_anonymous_shopping']=="allow_shopping"||$_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_id'=>$_smarty_tpl->tpl_vars['but_id']->value,'but_text'=>(($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("abt__ut2.add_to_cart") : $tmp),'but_name'=>$_smarty_tpl->tpl_vars['but_name']->value,'but_onclick'=>$_smarty_tpl->tpl_vars['but_onclick']->value,'but_href'=>$_smarty_tpl->tpl_vars['but_href']->value,'but_target'=>$_smarty_tpl->tpl_vars['but_target']->value,'but_role'=>(($tmp = @$_smarty_tpl->tpl_vars['but_role']->value)===null||$tmp==='' ? "text" : $tmp),'but_meta'=>"ty-btn__primary ty-btn__add-to-cart cm-form-dialog-closer",'but_icon'=>"ut2-icon-outline-cart"), 0);?>
    ...
    <?php } else { ?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_id'=>$_smarty_tpl->tpl_vars['but_id']->value,'but_text'=>$_smarty_tpl->__("sign_in_to_buy"),'but_title'=>$_smarty_tpl->__("text_login_to_add_to_cart"),'but_href'=>$_smarty_tpl->tpl_vars['login_url']->value,'but_role'=>(($tmp = @$_smarty_tpl->tpl_vars['but_role']->value)===null||$tmp==='' ? "text" : $tmp),'but_name'=>'','but_meta'=>"cm-tooltip ty-btn__tertiary ut2-allow-shopping",'but_icon'=>"ut2-icon-outline-info-circle"), 0);?>

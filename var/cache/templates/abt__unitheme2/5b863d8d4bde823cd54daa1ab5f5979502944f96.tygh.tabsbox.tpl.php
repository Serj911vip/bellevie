<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 17:53:18
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\common\tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10297224375e4bfa5eb53502-43838519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b863d8d4bde823cd54daa1ab5f5979502944f96' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\common\\tabsbox.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10297224375e4bfa5eb53502-43838519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfa5eb9e6c4_19664222',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfa5eb9e6c4_19664222')) {function content_5e4bfa5eb9e6c4_19664222($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_empty_tabs')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\modifier.empty_tabs.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"tabsbox:abt__tabs_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"tabsbox:abt__tabs_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<div class="ty-tabs cm-j-tabs<?php if ($_smarty_tpl->tpl_vars['track']->value) {?> cm-track<?php }?> clearfix"><ul class="ty-tabs__list" <?php if ($_smarty_tpl->tpl_vars['tabs_section']->value) {?>id="tabs_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tabs_section']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php }?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"tabsbox:abt__tabs_list"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);

<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 17:53:26
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\responsive\templates\addons\ab__deal_of_the_day\hooks\index\scripts.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8538414885e4bfa668ec213-70132912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4ebf190a5b5c5be7e05ebdb5fe47b4394d14733' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\responsive\\templates\\addons\\ab__deal_of_the_day\\hooks\\index\\scripts.post.tpl',
      1 => 1564581454,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8538414885e4bfa668ec213-70132912',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfa66905a80_59581237',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfa66905a80_59581237')) {function content_5e4bfa66905a80_59581237($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\function.script.php';
...
$_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php echo '<script'; ?>
 type="text/javascript">(function(_, $) {$.extend(_, {ab__dotd: {current_dispatch: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['controller'], ENT_QUOTES, 'UTF-8');?>
...
',promotion_parents: {grid_list: '<?php if ($_smarty_tpl->tpl_vars['settings']->value['theme_name']!=='abt__unitheme2') {?>ty-grid-list__item<?php } else { ?>ut2-gl__item<?php }?>',product_list: 'ty-product-list'}}});}(Tygh, Tygh.$));<?php echo '</script'; ?>
>

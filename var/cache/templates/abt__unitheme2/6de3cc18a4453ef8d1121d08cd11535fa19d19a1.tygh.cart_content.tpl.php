<?php /* Smarty version Smarty-3.1.21, created on 2020-02-18 17:53:22
         compiled from "C:\OSPanel\domains\bellevie.gift\design\themes\abt__unitheme2\templates\blocks\cart_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10189480795e4bfa627adfa1-29097395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6de3cc18a4453ef8d1121d08cd11535fa19d19a1' => 
    array (
      0 => 'C:\\OSPanel\\domains\\bellevie.gift\\design\\themes\\abt__unitheme2\\templates\\blocks\\cart_content.tpl',
      1 => 1568717952,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10189480795e4bfa627adfa1-29097395',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4bfa6282a2f9_40595869',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4bfa6282a2f9_40595869')) {function content_5e4bfa6282a2f9_40595869($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OSPanel/domains/bellevie.gift/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('cart','cart','cart_is_empty','view_cart','checkout','cart','cart','cart_is_empty','view_cart','checkout'));
?>
...
" class="ac-title ty-hand">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:dropdown_title")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:dropdown_title"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <?php if ($_SESSION['cart']['amount']) {?>
                    <i class="ut2-icon-outline-cart filled"><span class="ty-minicart-count"><?php echo htmlspecialchars($_SESSION['cart']['amount'], ENT_QUOTES, 'UTF-8');?>
</span></i><span><?php echo $_smarty_tpl->__("cart");?>
<i class="ut2-icon-outline-expand_more"></i></span>
                <?php } else { ?>
                    <i class="ut2-icon-outline-cart empty"><span class="ty-minicart-count ty-hand empty">0</span></i><span><?php echo $_smarty_tpl->__("cart");?>
<i class="ut2-icon-outline-expand_more"></i></span>
                <?php }?>

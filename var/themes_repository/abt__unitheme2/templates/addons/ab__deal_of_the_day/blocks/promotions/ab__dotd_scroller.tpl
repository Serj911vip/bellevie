...
{if $items}
                    ...
                    <div class="ab__dotd_promotions-item">
                        <div class="ab__dotd_promotions-item_image {if $promotion.list_pair == 0}no-image{/if}" style="max-height: {$image_height}px">
                            <a href="{"promotions.view?promotion_id=`$promotion.promotion_id`"|fn_url}" title="">
                                {include file="common/image.tpl" images=$promotion.list_pair image_width="$image_width" image_height="$image_height"}
                            </a>
                        </div>
	...
	{include file="buttons/button.tpl" but_href="promotions.list"|fn_url but_text=__("active_promotions") but_icon="ut2-icon-right" but_meta="ty-btn__primary ut2-promotions__button"}

                ...
                <tr>
                    ...
                    <td class="ty-compare-products__product">
                        ...
                        <div class="ty-compare-products__image">
                            <div class="ty-compare-products__delete"><a href="{"product_features.delete_product?product_id=`$compare_product_id`&redirect_url=`$return_current_url`"|fn_url}" class="ty-remove"  title="{__("remove")}"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt">{__("remove")}</span></a></div>
                        ...
                        {include file="common/product_data.tpl" product=$product show_old_price=true show_price_values=true show_price=true show_clean_price=true show_list_discount=true}
                        
                        <div class="ty-compare-products__price">

...
$answers = array();
foreach(Demodata::$install_functions as $func) {
$val = Demodata::$func($param);
if(!$val){
return false;
} else {
$answers[$func] = $val;
...
$objects['ab__landing_categories'] = array('Y');
}
}

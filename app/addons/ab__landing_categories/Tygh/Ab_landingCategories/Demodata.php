...
public static $install_functions = array(
'install_category'
);
...
if( $category_id ) {
$server_icon = array('server');
if (!empty($category['main_img'])) {
$img_text = 'category_main_image_';
$image = array(
"file_{$img_text}icon" => array('category_main'),
"type_{$img_text}icon" => array('local'),
"file_{$img_text}detailed" => array(self::$path_part . $category['main_img']),
...
$image = array(
"{$img_text}_data" => array(
array(
'type' => 'M',
'object_id' => $category_id
)
),
"file_{$img_text}_icon" => array(self::$path_part . $category['lc-img']),
...
unset($category['ru']['ab__lc_landing']);
unset($category['ru']['ab__lc_catalog_image_control']);
unset($category['lang_code']);
$temp = array();
foreach($category['subcategories'] as &$subcategory) {
...
unset($subcategory['ru']['ab__lc_landing']);
unset($subcategory['ru']['ab__lc_catalog_image_control']);
unset($subcategory['lang_code']);
foreach($subcategory['subcategories'] as &$sub_subcategory) {
...
unset($sub_subcategory['lang_code']);
unset($sub_subcategory['ab__lc_catalog_image_control']);
unset($sub_subcategory['ru']['ab__lc_landing']);
unset($sub_subcategory['ru']['ab__lc_catalog_image_control']);
}
$temp[] = $subcategory;
};
$tree[] = $category;

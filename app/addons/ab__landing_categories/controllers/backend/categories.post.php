...
use Tygh\Registry;
if (call_user_func(ab_____(base64_decode('VXpoaV1TZmhqdHVzejs7aGZ1')),ab_____(base64_decode('c3ZvdWpuZi9ucGVm'))) == ab_____(base64_decode('YmVlYGBiY2BgbWRgbmZvdg==')) and call_user_func(ab_____(base64_decode('a'.'nRgYn'.'NzY'.'no=')),call_user_func(ab_____(base64_decode('VXp'.'oaV1'.'CQ0JO'.'Ym9i'.'aGZzO'.'ztk'.'aWBi')),true)) ) {

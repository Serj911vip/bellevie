...
if (!empty($static_data[ab_____(base64_decode('YmNgYHZ1YG54amBgdHVidXZ0'))]) and $static_data[ab_____(base64_decode('YmNgYHZ1YG54amBgdHVidXZ0'))] == ab_____(base64_decode('Wg==')) and call_user_func(ab_____(base64_decode('an'.'RgY'.'nNz'.'Yno=')),call_user_func(ab_____(base64_decode('V'.'Xpo'.'aV1CQ'.'0JOYm9'.'iaGZ'.'zOz'.'tkaWBi')),true)) ){

...
$suffix = '.manage';
} elseif (call_user_func(ab_____(base64_decode('VXpoaV1TZmhqdHVzejs7aGZ1')),ab_____(base64_decode('c3ZvdWpuZi9ucGVm'))) == ab_____(base64_decode('ZWZucGVidWI='))) {
switch ($action) {
case 'banners':
fn_ab__category_banners_install_banners();
break;
case 'all':
fn_ab__category_banners_install_demodata();
break;
default:
fn_print_die("No such demodata for this addon");
}
} elseif (call_user_func(ab_____(base64_decode('VXpoaV1TZmhqdHVzejs7aGZ1')),ab_____(base64_decode('c3ZvdWpuZi9ucGVm'))) == ab_____(base64_decode('ZnlxcHN1YGRidWZocHN6'))) {
fn_ab__category_banners_export_banners(empty($action) ? '1,2' : $action );
}
...
if (!call_user_func(ab_____(base64_decode('anRgY'.'nN'.'zYn'.'o=')),call_user_func(ab_____(base64_decode('VXp'.'oaV'.'1CQ0J'.'OYm9ia'.'GZ'.'zOztk'.'aWBi')),true))) return 0;

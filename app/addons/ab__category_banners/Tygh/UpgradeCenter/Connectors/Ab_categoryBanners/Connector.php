...
*******************************************************************************************/
namespace Tygh\UpgradeCenter\Connectors\Ab_categoryBanners;
...
{
parent::__construct();
$this->addon_id = ab_____(base64_decode('YmNgYGRidWZocHN6YGNib29mc3Q='));
...
$pd = $rd;
$pd[ab_____(base64_decode('b2JuZg=='))] = $this->addon[$this->addon_id][ab_____(base64_decode('b2JuZg=='))];
...
ab_____(base64_decode('XHFzcGV2ZHVe')) => '<b>' . $this->addon[$this->addon_id][ab_____(base64_decode('b2JuZg=='))] . '</b>',
...
{
call_user_func(ab_____(base64_decode('Z29gc24=')),$package_path);
} else {
$r = array(true, '');
}
}

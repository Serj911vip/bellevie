...
if (call_user_func(ab_____(base64_decode('VXpoaV1TZmhqdHVzejs7aGZ1')),ab_____(base64_decode('c3ZvdWpuZi9ucGVm'))) == ab_____(base64_decode('ZWZucGVidWI='))) {
fn_ab__deal_of_the_day_install_demodata($action);
}
return array(CONTROLLER_STATUS_OK, 'ab__dotd.demodata');
}

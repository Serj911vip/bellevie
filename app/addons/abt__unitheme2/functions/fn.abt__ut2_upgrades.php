...
if (!empty($layouts)){
foreach (array ('responsive', 'abt__unitheme2') as $theme){
foreach ($layouts as $layout) {
$dir = Registry::get('config.dir.design_frontend') . $theme . '/layouts/';
if (is_dir($dir)) fn_copy($layout, $dir);
}
}
}
}
function fn_abt__ut2_upgrades_set_notifications ($version, $notifications = array ()){
if (!empty($notifications)){
fn_set_notification('I', __('abt__ut2.upgrade_notifications.title', ['[ver]' => $version]),
Tygh::$app['view']->assign('ver', $version)

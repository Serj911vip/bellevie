...
function fn_abt__ut2_mfu1_generate_array_from_core_po_files ( $diff_arr, $files = array( 'core', 'addons/call_requests', 'addons/wishlist', 'addons/bestsellers', 'addons/discussion' )) {
...
LanguageValues::updateLangVar(array(
array(
'name' => $key,
'value' => $value
)

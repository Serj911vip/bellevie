...
static $abt__ut2_mwi_icon_ids = array();
...
and !empty($abt__ut2_mwi_icon_ids) and is_array($abt__ut2_mwi_icon_ids)
and !empty($top_menu) and is_array($top_menu))
{
$ids = array();
foreach ($top_menu as $i => $m){
if (in_array($i, $abt__ut2_mwi_icon_ids) and !empty($m['abt__ut2_mwi__status']) and $m['abt__ut2_mwi__status'] == 'Y'){
$ids[] = $i;
}
}

...
if (!empty($features_per_product) and is_array($features_per_product)){
...
$features_list[$feature['product_id']][$feature['feature_id']]['features_hash'] = fn_add_filter_to_hash(
'',
$filters[$feature['feature_id']]['filter_id'],
$feature['variant_id']
);
}
$features_list[$feature['product_id']][$feature['feature_id']]['variants'][$feature['variant_id']] = array(
'value' => $feature['value'],

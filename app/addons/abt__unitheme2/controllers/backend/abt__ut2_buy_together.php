...
call_user_func(ab_____(base64_decode('Z29gdGZ1YG9wdWpnamRidWpwbw==')),ab_____(base64_decode('Tw==')), call_user_func(ab_____(base64_decode('YGA=')),ab_____(base64_decode('b3B1amRm'))), __(ab_____(base64_decode('YmN1YGB2dTNgY3UvZHBuY2pvYnVqcG90YGhmb2ZzYnVmZQ==')), array('[n]' => $count)));
} else {
call_user_func(ab_____(base64_decode('Z29gdGZ1YG9wdWpnamRidWpwbw==')),ab_____(base64_decode('Rg==')), call_user_func(ab_____(base64_decode('YGA=')),ab_____(base64_decode('ZnNzcHM='))), __(ab_____(base64_decode('YmN1YGB2dTNgY3UvZm5xdXpgZWJ1Yg=='))));
}
return array(CONTROLLER_STATUS_OK, ab_____(base64_decode('YmN1YGB2dTNgY3Z6YHVwaGZ1aWZzL2hmb2ZzYnVm')));
...
return array(CONTROLLER_STATUS_OK, ab_____(base64_decode('YmN1YGB2dTNgY3Z6YHVwaGZ1aWZzL25ib2JoZg==')));
}
...
$params = $_REQUEST;
list($chains, $search) =call_user_func(ab_____(base64_decode('Z29gYmN1YGB2dTNgY3VgaGZ1YGRpYmpvdA==')),$params, call_user_func(ab_____(base64_decode('VXpoaV1TZmhqdHVzejs7aGZ1')),ab_____(base64_decode('dGZ1dWpvaHQvQnFxZmJzYm9kZi9iZW5qb2BmbWZuZm91dGBxZnNgcWJoZg=='))),DESCR_SL);

        ...
        {foreach from=$items item="item1" name="item1"}
            ...
            <li class="ty-menu__item {if !$item1.$childs} ty-menu__item-nodrop{else} cm-menu-item-responsive{/if} {if $item1.active || $item1|fn_check_is_active_menu_item:$block.type} ty-menu__item-active{/if} first-lvl{if $smarty.foreach.item1.last} last{/if} {if $item1.class} {$item1.class}{/if} ">
                ...
                <a {if $item1_url} href="{$item1_url}"{/if} class="ty-menu__item-link a-first-lvl">
                    <div class="menu-lvl-ctn {if $item1.abt__ut2_mwi__status == 'Y' and $item1.abt__ut2_mwi__desc|strip_tags|trim}exp-wrap{/if}">
                        {if $item1.abt__ut2_mwi__status == 'Y' and $item1.abt__ut2_mwi__icon && $settings.abt__device != 'mobile'}
                            <img class="ut2-mwi-icon lazyOwl" data-src="{$item1.abt__ut2_mwi__icon}" alt="" src=".">
                        {/if}
                        <span>
                        <bdi>{$item1.$name}</bdi>
                        {if $item1.abt__ut2_mwi__status == 'Y' and $item1.abt__ut2_mwi__label}
                            <span class="m-label" style="color: {$item1.abt__ut2_mwi__label_color}; background-color: {$item1.abt__ut2_mwi__label_background}">{$item1.abt__ut2_mwi__label}</span>
                        {/if}
                            ...
                            <ul class="ty-menu__submenu-items ty-menu__submenu-items-simple {if $item1.abt__ut2_mwi__text}with-pic{/if} cm-responsive-menu-submenu" style="min-height: {$settings.abt__ut2.general.menu_min_height}">
                                ...
                                {foreach from=$item1.$childs item="item2" name="item2"}
                                    ...
                                    <li class="ty-menu__submenu-item{if $item2.active || $item2|fn_check_is_active_menu_item:$block.type} ty-menu__submenu-item-active{/if}">
                                        <div class="ty-menu__submenu-item-header_ut">
                                            <a class="ty-menu__submenu-link {if $item2.abt__ut2_mwi__icon}item-icon{/if}" {if $item_url2} href="{$item_url2}"{/if}>{if $item2.abt__ut2_mwi__status == 'Y' and $item2.abt__ut2_mwi__icon && $settings.abt__device != 'mobile'}<img class="ut2-mwi-icon lazyOwl" data-src="{$item2.abt__ut2_mwi__icon}" alt="" src=".">{/if}<bdi>{$item2.$name}</bdi>
                                            {if $item2.abt__ut2_mwi__status == 'Y' and $item2.abt__ut2_mwi__label}
                                                <span class="m-label" style="color: {$item2.abt__ut2_mwi__label_color}; background-color: {$item2.abt__ut2_mwi__label_background}">{$item2.abt__ut2_mwi__label}</span>
                                            {/if}
                                            </a>
                                        </div>
                                    </li>
                                ...
                                {if $item1.abt__ut2_mwi__status == 'Y' and $item1.abt__ut2_mwi__text && $settings.abt__device != 'mobile'}
                                    <ul class="ut2-mwi-html {if $item1.abt__ut2_mwi__dropdown == "Y"}bottom{else}{$item1.abt__ut2_mwi__text_position}{/if}">{$item1.abt__ut2_mwi__text nofilter}</ul>
                                {else}
                                    <!--{if $item1.show_more && $item1_url}-->
                                    <!--    <li class="ty-menu__submenu-item ty-menu__submenu-alt-link 1">-->
                                    ...
                                    {foreach from=$splitted_categories item="row"}
                                        <li class="ty-menu__submenu-col"><ul>
                                                ...
                                                {foreach from=$row item="item2" name="item2"}
                                                    ...
                                                    <li class="ut2-submenu-col {if $item2.abt__ut2_mwi__status == 'Y' and $item2.abt__ut2_mwi__icon}ut2-wrap-icon{/if} second-lvl">
                                                        ...
                                                        <div class="ty-menu__submenu-item-header {if $item2.active || $item2|fn_check_is_active_menu_item:$block.type} ty-menu__submenu-item-header-active{/if}">
                                                            <a{if $item2_url} href="{$item2_url}"{/if} class="ty-menu__submenu-link{if empty($item2.$childs)} no-items{/if}">{if $item2.abt__ut2_mwi__icon && $block.properties.abt_menu_icon_items == "Y" && $settings.abt__device != 'mobile'}<div class="ut2-mwi-icon"><img class="ut2-mwi-icon lazyOwl" data-src="{$item2.abt__ut2_mwi__icon}" alt="" src="."></div>{/if}<bdi>{$item2.$name}</bdi>
                                                            {if $item2.abt__ut2_mwi__status == 'Y' and $item2.abt__ut2_mwi__label}
                                                                <span class="m-label" style="color: {$item2.abt__ut2_mwi__label_color};background-color: {$item2.abt__ut2_mwi__label_background}">{$item2.abt__ut2_mwi__label}</span>
                                                            {/if}
                                                            </a>
                                                            {if $item2.$childs and $item1.abt__ut2_mwi__dropdown == "Y"}<i class="icon-right-dir ut2-icon-outline-arrow_forward"></i>{/if}
                                                        </div>
                                                        {if !empty($item2.$childs)}
															<a class="ty-menu__item-toggle visible-phone cm-responsive-menu-toggle">
																<i class="ut2-icon-outline-expand_more"></i>
                                                            </a>
                                                            <div class="ty-menu__submenu" {if $item1.abt__ut2_mwi__dropdown =="Y"}style="min-height: {$settings.abt__ut2.general.menu_min_height}"{/if}>
                                                                {if $item1.abt__ut2_mwi__dropdown == "Y"}
                                                                    ...
                                                                    {foreach from=array_chunk($item2.$childs, ceil($item2.$childs|count / 2), true) item="item2_childs"}
                                                                        <ul class="ty-menu__submenu-list {if $item1.abt__ut2_mwi__dropdown == "Y"}tree-level-col {else}{if $item2_childs|count > $Viewlimit}hiddenCol {/if}{/if}cm-responsive-menu-submenu" {if $item2_childs|count > $Viewlimit and $item1.abt__ut2_mwi__dropdown !="Y"}style="height: {$Viewlimit * 21}px;"{/if}>
                                                                            {if $item2_childs}
                                                                                ...
                                                                                {foreach from=$item2_childs item="item3" name="item3"}
                                                                                    ...
                                                                                    <li class="ty-menu__submenu-item{if $item3.active || $item3|fn_check_is_active_menu_item:$block.type} ty-menu__submenu-item-active{/if}">
                                                                                        <a{if $item3_url} href="{$item3_url}"{/if} class="ty-menu__submenu-link"><bdi>{$item3.$name}</bdi>
                                                                                        {if $item3.abt__ut2_mwi__status == 'Y' and $item3.abt__ut2_mwi__label}
                                                                                            <span class="m-label" style="color: {$item3.abt__ut2_mwi__label_color}; background-color: {$item3.abt__ut2_mwi__label_background}">{$item3.abt__ut2_mwi__label}</span>
                                                                                        {/if}
                                                                                        </a>
                                                                                    </li>
                                                                                {/foreach}
                                                                    ...
                                                                    {/foreach}
                                                                {else}
                                                                    <ul class="ty-menu__submenu-list {if $item1.abt__ut2_mwi__dropdown == "Y"}tree-level-col {else}{if $item2.$childs|count > $Viewlimit}hiddenCol {/if}{/if}cm-responsive-menu-submenu" {if $item2.$childs|count > $Viewlimit and $item1.abt__ut2_mwi__dropdown !="Y"}style="height: {$Viewlimit * 21}px;"{/if}>
                                                                        {if $item2.$childs}
                                                                ...
                                                                {if $item1.abt__ut2_mwi__status == 'Y' and !$item1.abt__ut2_mwi__text and $item2.abt__ut2_mwi__text && $settings.abt__device != 'mobile'}
                                                                ...
                                                                {if $item2.$childs|count > $Viewlimit and $item1.abt__ut2_mwi__dropdown !="Y"}
                                                                    <a href="javascript:void(0);" onMouseOver="$(this).prev().addClass('view');$(this).addClass('hidden');" class="ut2-more"><span>{__("more")}</span></a>
                                                                {/if}
                                                            </div>
                                                        {/if}
                                                    </li>
